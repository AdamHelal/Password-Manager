...
export default function EditPassword({ navigation }) {
  ...
  const netInfo = useNetInfo();
    ...
    return (
      ...
      <Formik
      initialValues={{ 
        webapp_name: navigation.getParam("item").name,
        username_email: navigation.getParam("item").username, 
        password: navigation.getParam("item").password
      }}
      
        onSubmit={(values,actions) => {
          navigation.getParam('function')(navigation.getParam("item"),{id:navigation.getParam("item").id,name:values.webapp_name, username:values.username_email, password:values.password},netInfo.isConnected)
          actions.resetForm();
          setLoading(true);
      ...
      {({ values, handleChange, handleBlur,errors, setFieldValue,setFieldTouched, touched, isValid, handleSubmit, enableReinitialize }) => (
          ...
          <SafeAreaView style={styles.container}>
            ...
            <MaterialIcons style={styles.spacingIcon} name="edit" size={28} color="#FA8E00" />
...
{        
        ...
        Alert.alert(
          ...
          { cancelable: false }
                    ...
                    <Text style={styles.buttonText}>Auto-Generate Password and Save</Text>
                </TouchableOpacity>
